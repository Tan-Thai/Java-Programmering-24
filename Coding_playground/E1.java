...
public class E1 {
    public static void main(String[] args) {
        ...
        //a.    A single byte can only contain a certain range -128 to 127. So 256 would not be able to convert to a byte
        //b.    The inverse of the previous question but a INT can contain a larger range, which includes all potential byte numbers.
        ...
        */
        ...
        /*1.7
        Ship calypso = new Ship(); <- would write this normally but im too lazy to create a new class file.

        a. It should be an object of "Ship", or an unique entity of ship in other words.
        b. It's a reference ID for that specific entity of "Ship".
        c. It would be the same reference ID as Calypso since it copied that specific entity.
        ...
        */
        ...
        b.  No, because it would declare both new variables with the same name. 
            If you want to change an existing variable, then just declare its name and not a typing.*/
        ...
        d.  Yes, but i feel like its a no? It returns ? and not an error, so im not sure.
        e.  Yes, because youre essentially creating a string with numbers. tho it cannot be calculated unless typecasted. (just use int)
        f.  Yes, I pressume that it converts 'A' to a ascii/unicode number. In this case 97
        ...
        j.  Yes? It converts 65 to 'A'. so im guessing its the american grading system?
        k.  No, should be "" and not single ''.
        I.  No, bool True/False. as much as 1/0 could be seen as true and false, its bound to lead to confusion.
        ...
        r.  Yes
        s.  Yes, though it will be "AliceBob" since neither had a space behind or in front respectively
        t.  Yes. it will take the 5th letter in this case, 4+1(add on an extra due to counting in 0)
        ...
        j.  true
        k.  false
        l.  false - A and B are the correct ASCII numbers, but this line said that B IS NOT 66.
        m.  True
        n.  True
        o.  True
        p.  True
        ...
        */         
        ...
        int a = 10, b = 20, c = 30;
        System.out.println("" + a + b + c); //added "" to create a string, otherwise i wouldve had to print multiple times
        ...
        if (value14 % 2 == 0) {
            System.out.println((value14 > 10) ? ("1.14: Is even and greater than 10"):("1.14: Is even and lower than 10"));
        } else{
            System.out.println((value14 > 10) ? ("1.14: Is odd and greater than 10"):("1.14: Is odd and lower than 10"));
        }
